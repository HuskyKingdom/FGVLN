...
from utils.dataset.all_dataset import YTbDataset,BeamDataset
import torch
import random
import numpy as np
...
def CorrectDis_Rate(y_true, y_pred):
    ...
    same = [1 for actual, predicted in zip(y_true, y_pred) if actual == predicted] # total num of same
...
class DownStreamDataset(BeamDataset):
